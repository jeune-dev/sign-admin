...
import { nombreFacture, nombreUtilisateur, nombreProfessionnelle, nombreIndependant } from "../../../service/admin/adminService";
import {
...
export default function Dashboard({ dashboardData }) {
  ...
  const fetchNombreProfessionnelle = async () => {
    try {
      ...
      setNbProfessionnelle(data.totalProfessionnels); // ← pas totalFactures !
    } catch (error) {
      console.error("Erreur lors de la récupération des utilisateurs :", error);
    }
  };
    ...
    <>
      ...
      <div className="dashboard-header">
        ...
        <div className="filters-container">
          <button className="refresh-btn" onClick={() => { fetchNombreFacture(); fetchNombreUtilisateur(); fetchNombreProfessionnelle ; fetchNombreIndependant()}}>
            <RefreshCw size={16} />
            Actualiser
          </button>
        </div>
